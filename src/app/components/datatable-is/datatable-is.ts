...
@Component({
    selector: 'is-rowExpansionLoader',
    template: ``
})
export class RowExpansionLoaderIS implements OnInit, OnDestroy {
...
export class ColumnHeadersIS {
    
    constructor(@Inject(forwardRef(() => DataTableIS)) public dt:DataTableIS) {}
    
    @Input("isColumnHeaders") columns: Column[];
}

@Component({
    selector: '[isColumnFooters]',
    template: `
...
export class ColumnFootersIS {
    
    constructor(@Inject(forwardRef(() => DataTableIS)) public dt:DataTableIS) {}
    
    @Input("isColumnFooters") columns: Column[];
}

@Component({
    selector: '[isTableBody]',
    template: `
            ...
            <tr #rowElement *ngIf="!dt.expandableRowGroups||dt.isRowGroupExpanded(rowData)"
                ...
                <ng-template ngFor let-col [ngForOf]="columns" let-colIndex="index">
                    <td #cell *ngIf="!dt.rowGroupMode || (dt.rowGroupMode == 'subheader') ||
                        ...
                        <is-dtRadioButton *ngIf="col.selectionMode=='single'" (onClick)="dt.selectRowWithRadio($event, rowData)" [checked]="dt.isSelected(rowData)"></is-dtRadioButton>
                        <is-dtCheckbox *ngIf="col.selectionMode=='multiple'" (onChange)="dt.toggleRowWithCheckbox($event,rowData)" [checked]="dt.isSelected(rowData)"></is-dtCheckbox>
                    </td>
                </ng-template>
            </tr>
            <tr *ngIf="dt.expandableRows && dt.isRowExpanded(rowData)" class="ui-expanded-row-content">
                <td [attr.colspan]="dt.visibleColumns().length">
                    <is-rowExpansionLoader [rowData]="rowData" [rowIndex]="rowIndex" [template]="dt.rowExpansionTemplate"></is-rowExpansionLoader>
                </td>
            </tr>
...
export class TableBodyIS {
    
    constructor(@Inject(forwardRef(() => DataTableIS)) public dt:DataTableIS) {}
    
    @Input("isTableBody") columns: Column[];
            ...
            <div #scrollHeaderBox  class="ui-datatable-scrollable-header-box">
                <table [ngClass]="dt.tableStyleClass" [ngStyle]="dt.tableStyle">
                    <thead class="ui-datatable-thead">
                        <tr *ngIf="!headerColumnGroup" class="ui-state-default" [isColumnHeaders]="columns"></tr>
                        <ng-template [ngIf]="headerColumnGroup">
                            <tr *ngFor="let headerRow of headerColumnGroup.rows" class="ui-state-default" [isColumnHeaders]="headerRow.columns"></tr>
                        </ng-template>
                    </thead>
                    <colgroup class="ui-datatable-scrollable-colgroup">
                        <col *ngFor="let col of columns" [ngStyle]="col.style" [ngClass]="{'ui-helper-hidden': col.hidden}"/>
                    </colgroup>
                    <tbody *ngIf="dt.frozenValue" [ngClass]="{'ui-datatable-data ui-widget-content': true, 'ui-datatable-hoverable-rows': (dt.rowHover||dt.selectionMode)}" [isTableBody]="columns" [data]="dt.frozenValue"></tbody>
                </table>
            </div>
        </div>
        <div #scrollBody class="ui-datatable-scrollable-body" [ngStyle]="{'width': width}">
            <div #scrollTableWrapper class="ui-datatable-scrollable-table-wrapper" style="position:relative">
                <table #scrollTable [class]="dt.tableStyleClass" [ngStyle]="dt.tableStyle" [ngClass]="{'ui-datatable-virtual-table':virtualScroll}" style="top:0px">
                    ...
                    <tbody [ngClass]="{'ui-datatable-data ui-widget-content': true, 'ui-datatable-hoverable-rows': (dt.rowHover||dt.selectionMode)}" [isTableBody]="columns" [data]="dt.dataToRender"></tbody>
                </table>
            </div>
        </div>
            ...
            <div #scrollFooterBox  class="ui-datatable-scrollable-footer-box">
                <table [ngClass]="dt.tableStyleClass" [ngStyle]="dt.tableStyle">
                    <tfoot class="ui-datatable-tfoot">
                        <tr *ngIf="!footerColumnGroup" [isColumnFooters]="columns" class="ui-state-default"></tr>
                        <ng-template [ngIf]="footerColumnGroup">
                            <tr *ngFor="let footerRow of footerColumnGroup.rows" class="ui-state-default" [isColumnFooters]="footerRow.columns"></tr>
                        </ng-template>
                    </tfoot>
                </table>
            </div>
...
export class ScrollableViewIS implements AfterViewInit,AfterViewChecked,OnDestroy {
    
    constructor(@Inject(forwardRef(() => DataTableIS)) public dt:DataTableIS, public domHandler: DomHandler, public el: ElementRef, public renderer: Renderer2, public zone: NgZone) {}
    
    @Input("isScrollableView") columns: Column[];
        ...
        <div [ngStyle]="style" [class]="styleClass" [style.width]="containerWidth"
            ...
            <div class="ui-datatable-tablewrapper" *ngIf="!scrollable">
                <table [ngClass]="tableStyleClass" [ngStyle]="tableStyle">
                    <thead class="ui-datatable-thead">
                        <tr *ngIf="!headerColumnGroups.first" class="ui-state-default" [isColumnHeaders]="columns"></tr>
                        <ng-template [ngIf]="headerColumnGroups.first">
                            <tr *ngFor="let headerRow of headerColumnGroups.first.rows" class="ui-state-default" [isColumnHeaders]="headerRow.columns"></tr>
                        </ng-template>
                    </thead>
                    <tfoot *ngIf="hasFooter()" class="ui-datatable-tfoot">
                        <tr *ngIf="!footerColumnGroups.first" class="ui-state-default" [isColumnFooters]="columns"></tr>
                        <ng-template [ngIf]="footerColumnGroups.first">
                            <tr *ngFor="let footerRow of footerColumnGroups.first.rows" class="ui-state-default" [isColumnFooters]="footerRow.columns"></tr>
                        </ng-template>
                    </tfoot>
                    <tbody [ngClass]="{'ui-datatable-data ui-widget-content': true, 'ui-datatable-hoverable-rows': (rowHover||selectionMode)}" [isTableBody]="columns" [data]="dataToRender"></tbody>
                </table>
            </div>
            
            <ng-template [ngIf]="scrollable">
                <div class="ui-datatable-scrollable-wrapper ui-helper-clearfix" [ngClass]="{'max-height':scrollHeight}">
                    <div *ngIf="hasFrozenColumns()" [isScrollableView]="frozenColumns" frozen="true"
                    ...
                    <div [isScrollableView]="scrollableColumns" [ngStyle]="{'width':this.unfrozenWidth, 'left': this.frozenWidth}"
...
export class DataTableIS implements AfterViewChecked,AfterViewInit,AfterContentInit,OnInit,OnDestroy,BlockableUI {
...
@NgModule({
    ...
    exports: [DataTableIS,SharedModule],
    declarations: [DataTableIS,DTRadioButtonIS,DTCheckboxIS,ColumnHeadersIS,ColumnFootersIS,TableBodyIS,ScrollableViewIS,RowExpansionLoaderIS]
})
export class DataTableISModule { }
