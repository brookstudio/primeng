...
export const MULTISELECT_IS_VALUE_ACCESSOR: any = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: forwardRef(() => MultiSelectIS),
  multi: true
};

@Component({
    selector: 'is-multiSelect',
    template: `
    ...
    `,
    providers: [DomHandler,ObjectUtils,MULTISELECT_IS_VALUE_ACCESSOR]
})
export class MultiSelectIS implements OnInit,AfterViewInit,AfterContentInit,AfterViewChecked,DoCheck,OnDestroy,ControlValueAccessor {
...
@NgModule({
    ...
    exports: [MultiSelectIS,SharedModule],
    declarations: [MultiSelectIS]
})
export class MultiSelectISModule { }
