...
export const LISTBOX_IS_VALUE_ACCESSOR: any = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: forwardRef(() => ListboxIS),
  multi: true
};
...
@Component({
  ...
  `,
  providers: [DomHandler,ObjectUtils,LISTBOX_IS_VALUE_ACCESSOR]
})
export class ListboxIS implements AfterContentInit,ControlValueAccessor {
...
@NgModule({
  ...
  exports: [ListboxIS, SharedModule],
  declarations: [ListboxIS]
})
export class ListboxISModule { }
